...
const Banners = () => {
  ...
  const handleExportPDF = () => {
    const headers = ['Title', 'Specialty', 'Location', 'Status', 'Image URL'];
    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <div className="flex gap-2">
          ...
          <button
            onClick={() => {
              setFormData({ id: null, title: '', imageUrl: '', specialty: 'All', location: 'dashboard_middle', isActive: true });
              setShowModal(true);
            }}
            ...
            <div className="p-4">
              ...
              <p className="text-sm text-gray-500 mb-4 flex items-center gap-2 flex-wrap">
                ...
                <span className="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs font-medium">
                  {banner.location.replace('_', ' ').toUpperCase()}
                </span>
              </p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <select
                  name="location"
                  required
                  value={formData.location || 'dashboard_middle'}
                  onChange={handleInputChange}
                  className="mt-1 input-field"
                >
                  <option value="dashboard_middle">Dashboard Middle</option>
                  <option value="dashboard_footer">Dashboard Footer</option>
                  <option value="sidebar">Sidebar</option>
                  <option value="profile_footer">Profile Footer</option>
                </select>
              </div>
